...
{    
        ...
        try{
            if($url){ 
                ...
                switch($url[0]){
                    ...
                    case "admin" : return call_user_func("App\Controllers\Admin\\".self::getAdminRoute($url));
                    break;
                    //Sinon on load le front
                    default : return call_user_func("App\Controllers\\".self::getRoute($url));
                    break;
                }
            }
    ...
    private function getAdminRoute($url) {
